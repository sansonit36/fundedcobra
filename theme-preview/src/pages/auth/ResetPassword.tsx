        ...
        <div className="w-full max-w-md">
          ...
          <div className="card-gradient rounded-2xl p-6 border border-white/5">
            <div className="text-center">
              ...
              <Link
                to="/forgot-password"
                className="inline-flex items-center justify-center w-full px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-lg transition-colors"
              >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-primary-500/50"
