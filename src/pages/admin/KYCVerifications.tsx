                      ...
                      <div className="flex space-x-2">
                        {verification.documents.map((doc) => (
                          <button
                            ...
                            className="px-3 py-1 rounded-full text-xs font-medium bg-primary-500/10 text-primary-400 hover:bg-primary-500/20 transition-colors flex items-center space-x-1"
                          >
