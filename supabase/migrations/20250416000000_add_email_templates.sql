...
('welcome', 'Welcome to FundedCobra - Start Your Trading Journey', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  <h1 style="color: #1e3a8a; text-align: center;">Welcome to FundedCobra</h1>
  <p>Hi {{name}},</p>
  <p>Thank you for joining FundedCobra! We''re excited to help you achieve your trading goals.</p>
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/dashboard" style="background: #3b82f6; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Go to Dashboard</a>
  </div>
</div>'),
...
('account_approved', 'Congratulations! Your Trading Account is Approved', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/trading-accounts" style="background: #059669; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">View Account Details</a>
  </div>
</div>'),
...
('kyc_reminder', 'Complete Your KYC Verification', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <p>Hi {{name}},</p>
  <p>You''re almost there! Complete your KYC verification to start trading with FundedCobra.</p>
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/kyc" style="background: #f59e0b; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Complete KYC Now</a>
  </div>
</div>'),
...
('account_purchase_reminder', 'Ready to Start Trading?', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <p>Hi {{name}},</p>
  <p>You''re registered with FundedCobra, but haven''t chosen your trading account yet.</p>
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/buy-account" style="background: #3b82f6; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">View All Accounts</a>
  </div>
</div>'),
...
('inactive_user', 'We Miss You at FundedCobra', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/dashboard" style="background: #3b82f6; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Back to Dashboard</a>
  </div>
</div>'),
...
('no_purchase_7days', 'Still Thinking? Here''s What You''re Missing', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/buy-account" style="background: #3b82f6; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Start Trading Today</a>
  </div>
</div>'),
...
('no_purchase_14days', 'Last Chance: Exclusive Offer Inside', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/buy-account" style="background: #7c3aed; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Claim Your Offer</a>
  </div>
</div>'),
...
('no_kyc_reminder', 'Complete Your Verification - Quick & Easy!', '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px 20px;">
  ...
  <div style="text-align: center; margin: 40px 0;">
    <a href="https://account.fundedcobra.com/kyc" style="background: #f59e0b; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; display: inline-block;">Complete Verification</a>
  </div>
</div>')
